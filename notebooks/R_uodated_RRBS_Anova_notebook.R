...
#dummy test contrast
contrast_test <- glmLRT(y_glm_fit, contrast = makeContrasts( (Sample1 + Sample3 + Sample5) - (Sample12 + Sample14 + Sample18), levels=design))
