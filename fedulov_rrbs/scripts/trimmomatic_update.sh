...
for sample in `ls /gpfs/data/cbc/fedulov_alexey/porcine_rrbs/trim_5_prime/*_trimmed.fq.gz`
do
    dir="/gpfs/data/cbc/fedulov_alexey/porcine_rrbs/trimmomatic_update"
